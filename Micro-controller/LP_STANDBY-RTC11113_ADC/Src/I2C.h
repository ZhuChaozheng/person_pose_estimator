...
#define SCL_H				  GPIOA->BSRR = SCL
#define SCL_L				  GPIOA->BRR  = SCL  
#define SDA_H				  GPIOA->BSRR = SDA
#define SDA_L				  GPIOA->BRR  = SDA
#define SCL_read			GPIOA->IDR  & SCL
#define SDA_read			GPIOA->IDR  & SDA
